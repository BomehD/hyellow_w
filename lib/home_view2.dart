...
class HomeView2 extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...interests.map((interest) =>
                      _buildInterestTile(context, theme, interest['label'], interest['icon'])).toList(),
                ],
              ),
            ),
          ),
  ...
  Widget _buildInterestTile(BuildContext context, ThemeData theme, String label, IconData icon) {
    return Card(
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => InterestsRelatedPosts(initialInterest: label),
            ),
          );
        },
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Icon(
                ...
                color: theme.iconTheme.color?.withOpacity(0.5), // Subtle arrow
                size: 18,
              ),
            ],
          ),
